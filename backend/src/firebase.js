...
if (!admin.apps.length) {
  try {
    ...
    console.log('Service account key not found, using environment variables for production');
    ...
    console.log('Firebase initialized with environment variables for project:', process.env.FIREBASE_PROJECT_ID);
  }
}
